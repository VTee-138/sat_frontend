        ...
        <Table sx={{ minWidth: 650 }}>
          <TableHead>
            ...
            >
              ...
              <TableCell align="center">{t("scoreDetails.section")}</TableCell>
              ...
              <TableCell align="center">{t("scoreDetails.actions")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {data.map((item, index) => {
              ...
              const sectionColors = getSectionColor(item.questionData?.section);
                ...
                >
                  ...
                  <TableCell>
                    <Box sx={{ maxWidth: 200 }}>
                      ...
                      >
                        {item.questionData?.question?.replace(/<[^>]*>/g, "") ||
                          "No question text"}
                      </Typography>
                    </Box>
                  </TableCell>
